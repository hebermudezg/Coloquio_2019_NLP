...
class KitchenSink(App, Screens):
    ...
    def __init__(self, **kwargs):
        ...
        self.previous_text = (
            f"Bienvenidos a la aplicación de Análisis de Texto [b][color={self.hex_primary_color}]"
            f"Unalytics[/color][/b].\n [b]"
        ...
        self.previous_text_end = (
          #  f"for show example apps\n\n"
            f"[b] Autores \n"
            f"Andrea Amaya[/color][/b], " 
            f"Laura Agudelo[/color][/b], "
            f"Camila Ospina[/color][/b] \n"
            f"Luisa Acosta[/color][/b], "
            f"Estefania Echeverry[/color][/b], "
            f"Esteban Bermúdez[/color][/b] \n "
            
            f"[u][b][color={self.hex_primary_color}]"
            f"unalyticsteam@gmail.com[/color][/b][/u]\n\n\n"
